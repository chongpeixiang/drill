...
extern void Gotest(GoInt32 p0, GoInterface p1);

extern GoInt Gocall(GoInt p0, GoInt p1);

extern GoInterface Gocall_(GoInt p0, GoInt p1);
# 3 "initcom_windows.h" 2
...
# 39 "initcom_windows.h"
typedef struct IClassFactory { const struct IClassFactoryVtbl * lpVtbl; } IClassFactory; 
typedef const struct IClassFactoryVtbl IClassFactoryVtbl; 
const struct IClassFactoryVtbl
{
 HRESULT (__attribute__((__stdcall__)) * QueryInterface) (void* This, CLASSID, void **); ULONG (__attribute__((__stdcall__)) * AddRef) (void* This); ULONG (__attribute__((__stdcall__)) * Release) (void* This);
 HRESULT (__attribute__((__stdcall__)) * CreateInstance) (void* This, POID, void **);
 HRESULT (__attribute__((__stdcall__)) * LockServer) (void* This,int);

};

typedef struct IDispatch { const struct IDispatchVtbl * lpVtbl; } IDispatch; typedef const struct IDispatchVtbl IDispatchVtbl; const struct IDispatchVtbl
{
 HRESULT (__attribute__((__stdcall__)) * QueryInterface) (void* This, CLASSID, void **);
  ULONG (__attribute__((__stdcall__)) * AddRef) (void* This); ULONG (__attribute__((__stdcall__)) * Release) (void* This);
 HRESULT (__attribute__((__stdcall__)) * GetTypeInfoCount) (void* This,UINT *pctinfo);
 HRESULT (__attribute__((__stdcall__)) * GetTypeInfo) (void* This,UINT iTInfo,LCID lcid,ITYTpeinto ** pp);
 HRESULT (__attribute__((__stdcall__)) * GetIDsOfNames) (void* This,UINT iTInfo,LCID lcid,ITYTpeinto ** pp);
 HRESULT (__attribute__((__stdcall__)) * Invoke) (void* This,UINT iTInfo,LCID lcid,ITYTpeinto ** pp);
};
# 2 "com_windows.h" 2
...
int isEqGuid(GoUintptr p0,GoUintptr p1){
 ...
 return (!memcmp((CLASSID)p0, (CLASSID)p1, sizeof(GUID)));
}
