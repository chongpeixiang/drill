...
func (self *Response)BucketList()(bucketList *BucketList, err error){
    return ParseListBucket(self.R.Body)
}
func (self *Response)ObjectList()(objectList *ObjectList, err error){
    return ParseListObject(self.R.Body)
}
